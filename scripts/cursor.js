...
const hoverTargets='a,button,input,select,textarea,label,.sup-btn,.item,.cat-hd,.mc,.br-card,.sidebar-nav a,.sidebar-logout,.filter-select,.admin-export-button,.admin-login-submit';
