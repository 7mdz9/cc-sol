...
const cards=await Promise.all(data.map(async item=>{
  ...
  return '<div class="mc rv '+item.revealClass+'"><div class="mc-img">'+svgText+'<div class="mc-layer">Coming Soon</div></div><div class="mc-name">'+item.name+'</div><div class="mc-price"><span class="mc-price-num">'+item.priceAed+'</span><span class="mc-price-unit">AED</span></div></div>';
}));
